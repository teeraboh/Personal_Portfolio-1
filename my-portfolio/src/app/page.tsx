  ...
  return (
    <main className="flex flex-col w-full justify-between bg-custom-gradient space-y-1 overflow-hidden mb-2">
      <section className="flex flex-col space-y-2 pt-4 items-center justify-center">
        ...
        <div className="flex flex-col w-full items-center justify-center relative lg:flex-row lg:justify-between lg:px-8 lg:-mt-52">
          <p className="text-center text-base font-medium text-textmed italic space-y-3 whitespace-nowrap lg:text-start lg:pb-52 lg:-mr-20 lg:relative lg:z-10">
          ...
          <div className="flex relative">
            <Image
              ...
              width={306}
              height={410}
              className="brightness-100 lg:w-[592px] lg:h-[790px] z-0"
              loading="lazy"
            />
          </div>
          <p className="text-center text-sm font-normal text-textnorm italic py-1 lg:text-right lg:pb-48 lg:-ml-20 lg:relative lg:z-10">
      ...
      <section className="flex flex-col w-full items-center justify-center space-y-2 bg-bgbutton lg:flex-row lg:pb-14 lg:-mt-44 lg:pt-16">
        ...
        <div className="flex flex-col pt-1 space-y-3 lg:pt-0 lg:pb-2">
          <Button
            type="button"
      ...
      <section>
        <div className="flex flex-col items-center justify-center mt-3 mb-5  bg-custom-gradient">
          ...
          <p className="text-left text-xs font-normal text-textnorm pt-5 pb-2">
            "Stay in touch! Contact me for collaborations, inquiries, or just to
            chat."
          </p>
          <div className="flex flex-col items-center justify-center my-5">
            <h1 className="text-base font-semibold text-textcolor text-center pb-1">
              Chat with me via
            </h1>
            ...
            <div className="flex flex-col items-start gap-4 px-8 py-2 my-6">
              <div className="flex flex-row items-center gap-2">
                <Image
                  ...
                  height={16}
                />
                <p className="underline underline-offset-8">Shoot me a mail</p>
              </div>
              ...
              <div className="flex flex-row items-center gap-4">
                <Image
                  ...
                  height={16}
                />
                <p className="underline underline-offset-8">Follow me on X</p>
              </div>
              ...
              <div className="flex flex-row items-center gap-3">
                <Image
                  ...
                  height={19}
                />
                <p className="underline underline-offset-8">Follow me on IG</p>
              </div>
            </div>
            <div className="flex w-full px-10 md:px-14">
              <SecondaryButton
                type="button"
